...
const nextConfig: NextConfig = {
  images: {
    remotePatterns: [
      ...
      {
        protocol: 'https',
        hostname: 'images.cocktailwave.com',
        port: '',
        pathname: '/**',
      },
      {
      ...
      {
        protocol: 'https',
        hostname: 'spaceshipsandlaserbeams.com',
        port: '',
        pathname: '/**',
      },
      {
        protocol: 'https',
        hostname: 'www.vegetarianventures.com',
        port: '',
        pathname: '/**',
      },
      {
        protocol: 'https',
        hostname: 'recipezed.com',
        port: '',
        pathname: '/**',
      },
      {
      ...
      {
        protocol: 'https',
        hostname: 'bakingmischief.com',
        port: '',
        pathname: '/**',
      },
      {
        protocol: 'https',
        hostname: 'www.shanazrafiq.com',
        port: '',
        pathname: '/**',
      },
      {
        protocol: 'https',
        hostname: 'dishesandflavors.com',
        port: '',
        pathname: '/**',
      },
      {
